...
module make_map_U1SE(){
    ...
    make_map_tile(hex="V22",large_station=1,tile_type="Fixed",home_company="LTS");
}
...
module make_map_U1NE(){
    ...
    make_map_tile(hex="U23",blocker="GER",small_station=1);
    make_map_tile(hex="U25",tile_type="Fixed",large_station=1);
    make_map_tile(hex="T18");
    make_map_tile(hex="T20",small_station=1);
    make_map_tile(hex="T22");
    make_map_tile(hex="T24",small_station=1);
    make_map_tile(hex="S17");
    make_map_tile(hex="S19");
    make_map_tile(hex="S21");
    make_map_tile(hex="S23");
    make_map_tile(hex="S25");
    make_map_tile(hex="R18");
    make_map_tile(hex="R20",small_station=1);
    make_map_tile(hex="R22");
    make_map_tile(hex="R24",large_station=1);
    make_map_tile(hex="R26",small_station=1);
}
...
module make_map_R3(){
    make_map_tile(hex="Q23",tile_type="Fixed",large_station=1,home_company="M&GN");
    make_map_tile(hex="Q25");
}
...
module make_map_U3NE(){
    ...
    make_map_tile(hex="F10",small_station=1,tile_type="Fixed");
    make_map_tile(hex="E07",large_station=2,tile_type="Fixed");
    make_map_tile(hex="E09",large_station=1,cost="$80");
    make_map_tile(hex="D08",cost="$100");
    make_map_tile(hex="D10",small_station=1);
    make_map_tile(hex="C07",cost="$100");
    make_map_tile(hex="C09",small_station=1,cost="$100");
    make_map_tile(hex="C11");
    make_map_tile(hex="B08",large_station=1,tile_type="Fixed",home_company="HR");
    make_map_tile(hex="B12",large_station=1,tile_type="Fixed",home_company="GNoS");
}
module make_map_U3NW(){
    make_map_tile(hex="F02",small_station=2,tile_type="Fixed");
    make_map_tile(hex="F04",small_station=1,cost="$140");
    make_map_tile(hex="F06",small_station=1);
    make_map_tile(hex="E01",large_station=1,tile_type="Fixed");
    make_map_tile(hex="E03",cost="$100");
    make_map_tile(hex="E05",cost="$100");
    make_map_tile(hex="D02",cost="$100");
    make_map_tile(hex="D04",cost="$100");
    make_map_tile(hex="D06",cost="$100");
}

module make_map_U3SW(){
    make_map_tile(hex="J02",large_station=1);
    make_map_tile(hex="J04",cost="$100");
    make_map_tile(hex="J06",large_station=1);
    make_map_tile(hex="I03",cost="$100");
    make_map_tile(hex="I05");
    make_map_tile(hex="I07",cost="$100");
    make_map_tile(hex="H04",small_station=2,blocker="GSWR");
    make_map_tile(hex="H06",large_station=1);
    make_map_tile(hex="G03",large_station=1);
    make_map_tile(hex="G05",large_station=2,tile_type="BGM");
    make_map_tile(hex="G07",small_station=2);
}
module make_map_U3SE(){
    make_map_tile(hex="K07",tile_type="Fixed",large_station=1,home_company="M&C");
    make_map_tile(hex="K09",cost="$100");
    make_map_tile(hex="K11",cost="$100");
    make_map_tile(hex="K13",small_station=1);
    make_map_tile(hex="K15",small_station=2);
    make_map_tile(hex="J08");
    make_map_tile(hex="J10",large_station=1);
    make_map_tile(hex="J12",cost="$100");
    make_map_tile(hex="J14",large_station=2,tile_type="OO",cost="$40");
    make_map_tile(hex="I09",cost="$100");
    make_map_tile(hex="I11",cost="$100");
    make_map_tile(hex="I13",small_station=2);
